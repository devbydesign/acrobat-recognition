    ...
    if (planDetailsForm) {
      planDetailsForm.addEventListener('submit', (e) => {
        ...
        if(planSummarySection) {
            ...
            const featureLinks = {
                'Welcome Kits': 'https://www.acrobatbranding.com/:quicksearch.htm?quicksearchbox=Welcome+Kits&LoP=&HiP=',
                'Years of Service': 'https://www.acrobatbranding.com/:quicksearch.htm?quicksearchbox=service+award&LoP=&HiP=',
                ...
                'General Awards': 'https://www.acrobatbranding.com/awards-recognition-paper-weights-crystal.htm',
        ...
        const mailtoLink = `mailto:sales@acrobatbranding.com,Katria.Lesser@webdevbydesign.com,rbadiner@rbbmarketing.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
